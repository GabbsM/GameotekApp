...
@Composable
fun DescubreScreen(navController : NavHostController, viewModel: RawGViewModel) {
    ...
    Scaffold(
        ...
        content = { paddingValues ->
            Column {
                ...
                DescubreContent(paddingValues = paddingValues, navHostController = navController, viewModel = viewModel)
            }
        },
