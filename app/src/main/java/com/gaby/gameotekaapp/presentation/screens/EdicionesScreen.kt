...
import com.gaby.gameotekaapp.presentation.contents.EdicionesContent

@Composable
fun EdicionesScreen(navController: NavHostController, viewModel: FilteredListViewModel) {

    Scaffold(
        topBar = {  DefaultTopBar(title = "Ediciones", upAvailable = false, navController = navController,color= Color.White) },
