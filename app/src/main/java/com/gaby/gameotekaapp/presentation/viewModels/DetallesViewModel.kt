...
import com.gaby.gameotekaapp.data.network.rawg.model.VideoJuegoDetalles
import com.gaby.gameotekaapp.data.network.rawg.model.ScreenshotResponse
import com.gaby.gameotekaapp.data.network.rawg.model.StoresResponse
...
class DetallesViewModel(gameId: Int?)  : ViewModel() {
    ...
    fun obtenerDetallesJuego(gameId: Int?) {
        viewModelScope.launch(Dispatchers.IO) {
            if (gameId != null) {
                val response = RetrofitClient.apiRawg.obtenerDetallesJuego(gameId, Constants.RAWG_API_KEY)
    ...
    fun getGameScreenshots(gamePk: String) {
        viewModelScope.launch(Dispatchers.IO) {
            val call = RetrofitClient.apiRawg.getGameScreenshots(gamePk, Constants.RAWG_API_KEY)
    ...
    fun getStores(gamePk: String){
        viewModelScope.launch(Dispatchers.IO) {
            val call = RetrofitClient.apiRawg.getGameStores(gamePk, Constants.RAWG_API_KEY)
