package com.gaby.gameotekaapp.presentation.screens.reviews
...
import com.gaby.gameotekaapp.presentation.screens.distribuidor.DistribuidorContent

@Composable
fun ReviewScreen(navController: NavHostController, viewModel: RawGViewModelList) {
