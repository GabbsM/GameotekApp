...
interface ApiRawg {
    ...
    suspend fun novedades(@Query("key") key: String): Response<VideoJuegosModel>
    ...
    //TODOS LOS JUEGOS
    @GET("games")
    suspend fun obtenerJuegos(@Query("key") key: String): Response<VideoJuegosModel>

    @GET("games")
    suspend fun obtenerJuegosPorDeveloper(@Query("key") key: String, @Query("developers") id: Int): Response<VideoJuegosModel>

    @GET("games")
    suspend fun obtenerJuegosPorPublisher(@Query("key") key: String, @Query("publishers") id: Int): Response<VideoJuegosModel>

    //MAS POPULARES
    @GET("games?dates=2023-01-01,2023-12-31&ordering=-added")
    suspend fun masPopulares(@Query("key") key: String): Response<VideoJuegosModel>
    ...
    suspend fun masValorados(@Query("key") key: String): Response<VideoJuegosModel>

    //PROXIMOS LANZAMIENTOS
    @GET("games?dates=2024-01-01,2024-01-31&platforms=18,1,7")
    suspend fun proximosLanzamientos(@Query("key") key: String): Response<VideoJuegosModel>
